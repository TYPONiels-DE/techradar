...
$GLOBALS['TCA']['tx_techradar_domain_model_techradar'] = array(
    ...
    'columns' => array(
        ...
        'cpid' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.cpid',
            'config' => array(
                'type' => 'input',
                'readOnly' => true,
                'size' => 30,
        ...
        'title_slug' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.titleSlug',
            'config' => array(
                'type' => 'input',
                'readOnly' => true,
                'size' => 30,
        ...
        'slugadditional' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.slugadditional',
            'config' => array(
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'teaser' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.teaser',
            'config' => array(
                'type' => 'text',
                'size' => 30,
                'eval' => 'trim'
        ...
        'url' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.url',
            'config' => array(
                'type' => 'input',
                'readOnly' => true,
                'size' => 30,
        ...
        'baseurl' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.baseurl',
            'config' => array(
                'type' => 'input',
                'readOnly' => true,
                'size' => 30,
        ...
        'status' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.status',
            'config' => array(
                'type' => 'input',
                'readOnly' => true,
                'size' => 30,
        ...
        'quadrant' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.quadrant',
            'config' => array(
                'type' => 'input',
                'readOnly' => true,
                'size' => 30,
        ...
        'area' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.area',
            'config' => array(
                'type' => 'input',
                'readOnly' => true,
                'size' => 30,
        ...
        'level' => array(
            'exclude' => 1,
            'label' => $TNL . 'tx_techradar_domain_model_techradar.level',
            'config' => array(
                'type' => 'input',
                'readOnly' => true,
                'size' => 30,
        ...
        'media' => [
            'label' => $TNL . 'tx_techradar_domain_model_techradar.media',
            'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
                ...
                [
                    ...
                    'foreign_match_fields' => [
                        'fieldname' => 'media',
                        'tablenames' => 'tx_techradar_domain_model_techradar',
